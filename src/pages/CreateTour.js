            ...
            <>
                ...
                <div className="base-container">
                    <div className="header">
                        Desire to create your own Tour? <br /> Fill in the
                        details of your new tour below.
                    </div>
                            ...
                            <div className="form-group">
                                ...
                                <div className="form-group">
                                    <label htmlFor="description">
                                        Description and Features of your Tour
                                    </label>
                                    <textarea
                                        name="description"
                                ...
                                <div className="form-group">
                                    <label htmlFor="cost">
                                        The admission cost of your Tour
                                    </label>
                                    <input
                                        type="text"
                                        name="price"
